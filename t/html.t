...
<div style="font-family:Consolas,'Liberation Mono',Courier,monospace;padding:0 8px 0 11px;white-space:pre;font-size:13px;line-height:18px;float:left"><span style="color:#0086B3">print</span><span style="color:#FFF"> </span><span style="color:#D14">&#39;Foo&#39;</span><span style="color:#333">;</span></div>
</div>
